...
app = FastAPI(
    ...
    description="Marketing Campaign Planner powered by Gemini",
    version="1.0.0"
)

# Allow React Vite (port 5173) and CRA (3000)
origins = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://localhost:5173",
...
#app.include_router(trends.router, tags=["Market Trends"])  # Registers /market-trends
